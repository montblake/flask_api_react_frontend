function Characters(){
    return (
    <main id="characters" className="toggle-content">
        <section>
            <h2>Django</h2>
            <p>A perfectionist with a deadline. Ridiculously fast, Django moves from idea to action quickly. Takes security seriously.  Dat zijn ook makelaars in koffie, doch hun adres behoeft ge niet te weten. Ik pas er dus wel op, dat ik geen romans schrijf, of andere valse opgaven doe.</p>
        </section>
        <section>
            <h2>Flask</h2>
